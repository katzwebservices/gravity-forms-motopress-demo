...
define( 'GF_MOTOPRESS_VERSION', '0.1' );

add_action( 'gform_loaded', 'register_gf_motopress' );

function register_gf_motopress() {
	...
	require_once plugin_dir_path( __FILE__ ) . 'class-gf-motopress.php';

	GFAddon::register( 'GF_MotoPress' );
}